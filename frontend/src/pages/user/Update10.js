...
const Update = () => {
    ...
    const formik = useFormik({
        initialValues: {
            institute: user.education10 && user.education10.institute,
            passingYear: user.education10 && user.education10.passingYear,
            marks: user.education10 && user.education10.marks
        },
        validationSchema: validationSchema,
        onSubmit: (values, actions) => {
            dispatch(userEditAction({ education10: {...values}, id: user._id }, user._id));
            navigate("/user/edit/edu12");
        }
    })
