...
const Update = () => {
    ...
    const formik = useFormik({
        initialValues: {
            institute: user.educationBachelor && user.educationBachelor.institute,
            passingYear: user.educationBachelor && user.educationBachelor.passingYear,
            marks: user.educationBachelor && user.educationBachelor.marks
        },
        validationSchema: validationSchema,
        onSubmit: (values, actions) => {
            dispatch(userEditAction({ educationBachelor: {...values}, id: user._id }, user._id));
            navigate("/user/edit/other");
        }
    })
