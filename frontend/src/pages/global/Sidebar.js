...
const SidebarAdm = () => {
    ...
    const home = () => setTimeout(() => { navigate('/'); }, 500);
    const update = () => setTimeout(() => { navigate('/user/edit/personal'); }, 500);
    const logOut = () => {
            ...
            <Sidebar backgroundColor="#003366" style={{ borderRightStyle: "none" }}>
                <Box sx={{ display: "flex", justifyContent: "space-between", flexDirection: "column", height: "100%" }}>
                        ...
                        >
                            {
                                userInfo && userInfo.role === 1 ?
                                    ...
                                    <>
                                        ...
                                        <MenuItem component={<Link to="/recruiter/users" />} icon={<GroupAddIcon />}> Users </MenuItem>
                    ...
                    <Box sx={{ pb: 2 }}>
                        ...
                        >
                            <MenuItem onClick={home} icon={<HomeIcon />}>   Home </MenuItem>
                            {userInfo && userInfo.role === 0 ? <MenuItem onClick={update} icon={<EditIcon />}>   Update </MenuItem> : <></>}
