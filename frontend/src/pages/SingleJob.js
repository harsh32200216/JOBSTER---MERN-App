...
const SingleJob = () => {
    ...
    const applyForAJob = () => {
        dispatch(userApplyJobAction({
            job_id: singleJob && singleJob._id,
            creater_id: singleJob && singleJob.user,
                            ...
                            <Box sx={{ flex: 4, p: 2 }}>
                                {
                                    loading ? <LoadingBox /> :
                                        <Card>
                                            ...
                                            <Button onClick={applyForAJob} sx={{ position: "absolute", right: "20px", fontSize: "13px" }} variant='contained'>Apply</Button>
